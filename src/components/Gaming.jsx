    ...
    return (
        ...
        <main id="gaming" className="relative">
            ...
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap justify-center" >
                <div className="group lg:w-1/2 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 px-10 pb-10 flex items-start justify-center relative">
                    <img className={"group-hover:hidden w-full sm:w-full lg:w-1/2 rounded-full border-8"} alt={"Praise Her!"} src="./assets/gamingProfile.png"/>
                    <img className={"hidden group-hover:block w-full sm:w-full lg:w-1/2 rounded-full border-8"} alt={"The Krew"} src="./assets/rabbitCorp.png"/>
                </div>
